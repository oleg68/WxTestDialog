...
WxTestDialog2::Page1::Page1(wxWindow *parent) : wxPanel(parent, wxID_ANY)
{
...
bool WxTestDialog2::Page1::TransferDataToWindow()
{
...
WxTestDialog2::Page2::Page2(wxWindow *parent) : wxPanel(parent, wxID_ANY)
{
